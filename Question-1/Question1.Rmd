...
```{r}
ggplot(cases_malaysia, aes(x = as.Date(date), y = cases_new)) + geom_line(color = "#69b3a2") + labs(title = "Daily New Cases in Malaysia", x = "Date", y = "Total Daily Dose", color = "State") + theme_fivethirtyeight() + theme(axis.title = element_text()) + scale_x_date(date_breaks = "3 month", labels = date_format("%d-%b-%y"))
```
