...
ggplot(val, aes(x = state, y = full, color = state)) + geom_bar(stat = "identity", fill = "white") + geom_text(aes(label = full), hjust = 1.5 , size = 3.5) + ylim(0, 100) + labs(x = "State", y = "Percentage (%)", title = "Full Vaccinated Status in Malaysia") + theme(legend.position = "none") + coord_flip()
