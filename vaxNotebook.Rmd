...
ggplot(val, aes(val_x, val_y)) + theme_bw() + geom_bar(stat = "identity", fill = c("#aef359", "#3cb043")) + geom_text(aes(label = val_y), vjust = -0.3, size = 4) + labs(x = "Status", y = "Percentage (%)", title = "Vaccinated Progress in Malaysia") + ylim(0, 100)
```
